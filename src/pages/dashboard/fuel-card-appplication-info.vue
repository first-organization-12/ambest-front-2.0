      ...
      <q-card-section>
        ...
        <q-dialog v-model="isModalOpen">
          <q-card style="width: 500px">
            <q-card-section>
              <div class="text-h6">Fuel Card Application Details</div>
            </q-card-section>
...
export default {
  setup() {
    ...
    // Fetch data from API
    const fetchData = () => {
      api.get('get-ambest-Fuel-card-application')
      .then((response)=>{
    ...
    const modalRows = computed(() => {
      ...
      return [
        ...
        { field: "Card Type", value:selectedRow.value.card_type+' fuel card ' },
        { field: "Contact Name", value: selectedRow.value.contact_name },
        { field: "Corporate Name", value: selectedRow.value.corporate_name },
